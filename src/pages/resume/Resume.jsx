...
export default function ResumePage({ }) {
    ...
    const { scale, pageSize } = useOutletContext();
    ...
    return (
        <>
            ...
            <main 
                ...
                className={cn(
                    "resume-page group relative py-20 print:p-0 hidden pointer-fine:flex justify-center",
            ...
            >
                <motion.div
                    ...
                    className="inline-block data-[is-grabbing=true]:cursor-grabbing cursor-grab"
                    drag initial={{ scale: 1 }}
                    dragMomentum={false}
                    animate={{ scale: scale }}
                >
                    ...
                    >
                        <div className="header flex flex-col group-data-[page-size=business]:h-full">
                            ...
                            <div className="
                                    ...
                                    border-b-0 border-dashed pb-2 font-[MisterPixel]
        ...
        return (
            <div className="resume-project flex flex-col">
                ...
                <div className="external text-xs flex-grow flex flex-col justify-end  text-center opacity-50 pb-1.5">
                    ...
                    {project.displaySource !== project.displayUrl && (
    ...
    return (
        <ResumeSection title="projects" showDivider>
            <div className="resume-projects-content flex *:flex-1/3 gap-3">
                ...
                <ResumeProject project={projects[13]} />
            </div>
        </ResumeSection>
    );
}
