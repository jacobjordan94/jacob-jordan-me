export default ({ className = '', size = 24 }) =>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={size} height={size} className={'textWhite ' + className}>
        <g>
            ...
            <path d="M28.95 9.14h1.53v3.05h-1.53Z" fill="currentColor" strokeWidth="1"></path>
            ...
            <path d="M22.86 27.43h3.04v1.52h-3.04Z" fill="currentColor" strokeWidth="1"></path>
            <path d="M22.86 3.05h3.04v1.52h-3.04Z" fill="currentColor" strokeWidth="1"></path>
            <path d="M19.81 28.95h3.05v1.53h-3.05Z" fill="currentColor" strokeWidth="1"></path>
            <path d="m21.33 22.86 -1.52 0 0 -7.62 -1.52 0 0 -1.53 -4.58 0 0 1.53 -1.52 0 0 10.66 1.52 0 0 1.53 7.62 0 0 -1.53 1.53 0 0 -1.52 -1.53 0 0 -1.52z" fill="currentColor" strokeWidth="1"></path>
            <path d="M19.81 1.52h3.05v1.53h-3.05Z" fill="currentColor" strokeWidth="1"></path>
            <path d="M12.19 30.48h7.62V32h-7.62Z" fill="currentColor" strokeWidth="1"></path>
            <path d="m13.71 12.19 4.58 0 0 -1.52 1.52 0 0 -4.58 -1.52 0 0 -1.52 -4.58 0 0 1.52 -1.52 0 0 4.58 1.52 0 0 1.52z" fill="currentColor" strokeWidth="1"></path>
